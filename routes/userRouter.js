...
/*------------------------------oderManagmnt----------------------------------*/
router.post('/order_place',auth.userBlock,orderController.orderPlace)
router.get('/order_details',auth.userBlock,orderController.order_details)
router.get('/cancel',auth.userBlock,orderController.order_cancel)
router.get('/order_invoice',auth.userBlock,orderController.order_invoice)
...
router.put('/return',auth.userBlock,actionController.return_confirm)
router.get('/wallet',auth.userBlock,actionController.wallet_page)
